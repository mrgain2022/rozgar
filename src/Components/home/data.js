const homecon = [
    {
        abouthead: 'What they think',
        aboutcon: 'The city and town name generator uses a database of over five million names across more than 150 countries. If you are looking for a random city or town name to spark a location for a book, game, or a script, millions of possibilities are at your finger tips. How you use the city or town name is up to you.'
    }
]

const servicesBox = [
    {
        skillIcon: <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        skillcon: 'Hic nesciunt galisum aut dolorem aperiam eum soluta quod ea cupiditate.',
    ...
    },
    {
        ...
        skilltitle: 'Construction',
        skillcon: 'Hic nesciunt galisum aut dolorem aperiam eum soluta quod ea cupiditate.',
        button: 'Explore Section',
    },
    {
        skillIcon: <svg width="40" height="43" viewBox="0 0 40 43" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const event = [
    {
        eventtitle: 'UX Design Conference',
        eventimg: 'Speaker',
        eventimgname01: 'assets/img/event/event-speaker-1.jpg',
        eventimgname02: 'assets/img/event/event-speaker-1.jpg',
        eventdate: 'October 16, 2022',
        eventbtn: 'Buy Tickets ',
    },
    {
        eventtitle: 'Networking and Data Science',
        eventimg: 'Speaker',
        eventimgname01: 'assets/img/event/event-speaker-1.jpg',
        eventimgname02: 'assets/img/event/event-speaker-1.jpg',
        eventdate: 'July 17, 2022',
        eventbtn: 'Buy Tickets ',
    },
    {
        eventtitle: 'Digital Marketing',
        eventimg: 'Speaker',
        eventimgname01: 'assets/img/event/event-speaker-1.jpg',
        eventimgname02: 'assets/img/event/event-speaker-1.jpg',
    ...
    {
        eventtitle: 'Webinar for Developers',
        eventimg: 'Speaker',
        eventimgname01: 'assets/img/event/event-speaker-1.jpg',
        eventimgname02: 'assets/img/event/event-speaker-1.jpg',
        eventdate: 'April 14, 2022',
        eventbtn: 'Buy Tickets ',
    }
]
...
const faq = [
    {
        faqtitle: 'Can I cancel my account at any time?',
        faqcon: 'Non similique culpa in provident quos sit commodi beatae ea laborum suscipit id autem velit aut iusto odio et deleniti quis et doloremque enim vel consequuntur quos.',
        id: "headingOne",
        col: 'collapseOne'
    },
    {
        faqtitle: 'What happens after the license expires?',
        faqcon: 'Non similique culpa in provident quos sit commodi beatae ea laborum suscipit id autem velit aut iusto odio et deleniti quis et doloremque enim vel consequuntur quos.',
        id: "headingTwo",
        col: 'collapseTwo'
    },
    {
        faqtitle: 'Does Harry have any documentations?',
        faqcon: 'Non similique culpa in provident quos sit commodi beatae ea laborum suscipit id autem velit aut iusto odio et deleniti quis et doloremque enim vel consequuntur quos.',
        id: "headingThree",
        col: 'collapseThree'
    },
    {
        faqtitle: 'How long do I get support & updates?',
        faqcon: 'Non similique culpa in provident quos sit commodi beatae ea laborum suscipit id autem velit aut iusto odio et deleniti quis et doloremque enim vel consequuntur quos.',
        id: "headingFour",
        col: 'collapseFour'
    }
...
const blog = [
    {
        id: '1',
        blogimg: 'assets/img/blog/1/blog-1.jpg',
        bloghead: 'Helping BIPOC employees fight burnout and find community',
        blogcat: 'Work Life',
        blogdate: 'January 14, 2022',
        blogtime: ' 4 Min Read',
    ...
    {
        id: '2',
        blogimg: 'assets/img/blog/1/blog-2.jpg',
        bloghead: 'How To Build Trust, Increase Authority, And Rank High With Google',
        blogcat: 'Consulting',
        blogdate: 'January 15, 2022',
        blogtime: ' 6 Min Read',

    },
    {
        id: '3',
        blogimg: 'assets/img/blog/1/blog-3.jpg',
        bloghead: 'Helping BIPOC employees fight burnout and find community',
        blogcat: 'Work Life',
        blogdate: 'January 14, 2022',
        blogtime: ' 4 Min Read',
    ...
    {
        id: '4',
        blogimg: 'assets/img/blog/grid/blog-grid-2.jpg',
        bloghead: 'Look at usual things with unusual eyes',
        blogdisc: 'Lorem ipsum is simply dummy text ipsum been dummy...',
        blogcat: 'Music',
        blogdate: 'anuary 22, 2022',
        blogauthorImg: 'assets/img/users/user-2.jpg',
        blogauthor: 'Shahnewaz',
        blogComment: '33',
        blogview: '1234,5k',
    },
    {
        id: '5',
        blogimg: 'assets/img/blog/grid/blog-grid-3.jpg',
        bloghead: 'An economist’s guess is liable good as anybody',
        blogdisc: 'Lorem ipsum is simply dummy text ipsum been dummy...',
        blogcat: 'Business',
        blogdate: 'anuary 22, 2022',
        blogauthorImg: 'assets/img/users/user-2.jpg',
    ...
    {
        id: '6',
        blogimg: 'assets/img/blog/grid/blog-grid-4.jpg',
        bloghead: 'How Can Designers Prepare For The Future?',
        blogdisc: 'Lorem ipsum is simply dummy text ipsum been dummy...',
        blogcat: 'Business',
        blogdate: 'anuary 22, 2022',
        blogauthorImg: 'assets/img/users/user-2.jpg',
    ...
    {
        id: '7',
        blogimg: 'assets/img/blog/grid/blog-grid-5.jpg',
        bloghead: 'How Can Designers Prepare For The Future?',
        blogdisc: 'Lorem ipsum is simply dummy text ipsum been dummy...',
        blogcat: 'Greatives Web',
        blogdate: 'anuary 22, 2022',
        blogauthorImg: 'assets/img/users/user-2.jpg',
        blogauthor: 'Crish',
        blogComment: '35',
...
const BlogDetailsData = [
    {
        id: '1',
        catName: 'Business',
        detailHead: 'Investment Trend Monitor: Top Trends in 2022',
        detailImg: 'assets/img/blog/blog-big-1.jpg',
        DauthorImg: 'assets/img/users/user-12.jpg',
        AuthorName: 'Fig Nelson',
        AuthorView: '12,145',
        PageHead: 'As influential as runways are, trends not solely born them. There was a clear direction coming their social media platform.',
        PagePara: 'One morning, when Gregor Samsa woke from troubled dreams, he found himself transformed in his bed into a horrible vermin. He lay on his armour-like back, and if he lifted his head a little he could see his brown belly, slightly domed and divided by arches into stiff sections. The bedding was hardly able to cover it and seemed ready to slide off any moment.',
        PageImg: 'assets/img/blog/details/blog-details-1.jpg',
        PagePara2: "His many legs, pitifully thin compared with the size of the rest of him, waved about helplessly as he looked. What's happened to me? he thought. It wasn't a dream. His room, a proper human room although a little too small, lay peacefully between its four familiar walls. A collection of textile samples lay spread out on the table - Samsa was a travelling salesman - and above it there hung a picture that he had recently cut out of an illustrated magazine.",
        PageQuote: '“I try as much as possible to give you a great basic product and what comes out, I feel, is really amazing.”',
    },
]
...
export { homecon, servicesBox, event, faq, blog, BlogDetailsData ,category, }