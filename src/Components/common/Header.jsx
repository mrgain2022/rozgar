    ...
    <React.Fragment>      
      ...
      <header>
         <div className="header__area header__transparent">
                     ...
                     <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-2">
                        <div className="header__top-right d-flex justify-content-end align-items-center">
                           <div className="header__lang ml-30">
                              <span className="header__lang-selected-lang tp-lang-toggle" id="tp-header-lang-toggle">English</span>
            ...
            <div className="header__bottom header__bottom-border header__sticky" id="header-sticky">
               <div className="container">
                  <div className="mega-menu-wrapper p-relative">
                     <div className="row align-items-center">
                        <div className="col-xxl-2 col-xl-2 col-lg-2 col-md-4 col-sm-5 col-8">
                           <div className="logo logo-border">
                              <a className='text-white fs-3' href="/">
                                 Rozgar.com
                              </a>
                           </div>
                        </div>
                           ...
                           <div className="main-menu pl-55 main-menu-ff-space">
                              <nav id="mobile-menu">
                                 <ul>
                                    ...
                                    <li>
                                       <a href={constant.component.aboutUs.url}>About Us</a>
                                    </li>
                                    
                                    <li>
                                       <a href={constant.component.Blog.url}>Blog</a>
                                    </li>
                                    <li>
                                       <a href="#">Pages</a>
                                    </li>
