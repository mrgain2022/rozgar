...
import Img from '../../assets/img/about/about-breadcrumb.jpg';

export default function aboutus() {
    return (
        <React.Fragment>
            <main>
                <section className="about__heading about__heading-overlay about__spacing include-bg jarallax" style={{backgroundImage: `url(${Img})`}}>
                        ...
                        <div className="row justify-content-center">
                            <div className="col-xl-8 col-lg-10">
                                <div className="about__heading-content text-center p-relative z-index-1">
                                    ...
                                    <h3 className="about__heading-title">Need a design expert? You found one.</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row">
                            <div className="col-xl-4 col-lg-4">
                                <div className="about__text-wrapper wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                                    <h3 className="about__text-title">It started with a <br/> bang now we're here.</h3>
                                </div>
                            </div>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                                <div className="services__item-9 services__item-style-2 mb-30 transition-3">
                                    <div className="services__item-9-top d-flex align-items-start justify-content-between">
                                        ...
                                        <div className="services__btn-9">
                                            <a href="services-details.html"><i className="fa-light fa-arrow-up-right"></i></a>
                                        </div>
                                    </div>
                                    <div className="services__content-9">
                                        <span className="services-project">86 Project</span>
                            ...
                            <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                                <div className="services__item-9 mb-30 services__item-style-2 transition-3">
                                    <div className="services__item-9-top d-flex align-items-start justify-content-between">
                                        <div className="services__icon-9">
                                            <span>
                                    ...
                                    <div className="services__content-9">
                                        <span className="services-project">63 Project</span>
                                        <h3 className="services__title-9">
                                            <a href="services-details.html">Mobile App Design</a>
                                        </h3>
                                    </div>
                                </div>
                            </div>
                            <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                                <div className="services__item-9 mb-30 services__item-style-2 transition-3">
                                    ...
                                    <div className="services__content-9">
                                        <span className="services-project">75 Project</span>
                                        <h3 className="services__title-9">
                                            <a href="services-details.html">Dashboard</a>
                                        </h3>
                                    </div>
                                </div>
                            </div>
                ...
                <section className="award__area pt-120 pb-120 white-bg">
                    <div className="container">
                        <div className="row">
                            <div className="col-xxl-12">
                                <div className="section__title-wrapper mb-55 text-center">
                                    <h3 className="section__title">Our Awards.</h3>
                                </div>
                            </div>
                        </div>
                        <div className="row">
                            <div className="col-xxl-12">
                                <div className="award__item-wrapper-9 award__style-2">
                                    <div className="award__item-9 p-relative wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                                        <div className="row align-items-center">
                                            ...
                                            <div className="col-xl-7 col-lg-7 col-md-7">
                                                <div className="award__content-9">
                                                    <h3 className="award__title-9">
                                                        <a href="services-details.html" className="tp-img-reveal tp-img-reveal-item" data-img="assets/img/award/9/award-1.jpg" data-fx="1">Modern painting award jump</a>
                                                    </h3>
                                            ...
                                            <div className="col-xl-2 col-lg-2 col-md-2">
                                                <div className="award__btn-9 text-md-end">
                                                    <a href="services-details.html" className="career-link-btn">
                                    ...
                                    <div className="award__item-9 p-relative wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                                        <div className="row align-items-center">
                                            <div className="col-xl-3 col-lg-3 col-md-3">
                                                <div className="award__topic">
                                            ...
                                            <div className="col-xl-7 col-lg-7 col-md-7">
                                                <div className="award__content-9">
                                                    <h3 className="award__title-9">
                                                        <a href="services-details.html" className="tp-img-reveal tp-img-reveal-item" data-img="assets/img/award/9/award-2.jpg" data-fx="1">People's choice: best design</a>
                                                    </h3>
                                                    <p>Runner Up - “ Decor of the week “</p>
                                                </div>
                                            </div>
                                    ...
                                    <div className="award__item-9 p-relative wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                                        <div className="row align-items-center">
                                            <div className="col-xl-3 col-lg-3 col-md-3">
                                                <div className="award__topic">
                                                    <p>Art direction 2021</p>
                                            ...
                                            <div className="col-xl-7 col-lg-7 col-md-7">
                                                <div className="award__content-9">
                                                    <h3 className="award__title-9">
                                                        <a href="services-details.html" className="tp-img-reveal tp-img-reveal-item" data-img="assets/img/award/9/award-3.jpg" data-fx="1">Webby's, Site of the Year</a>
                                                    </h3>
                                                    <p>Runner Up - “ Decor of the week “</p>
                                                </div>
                                            </div>
                                    ...
                                    <div className="award__item-9 p-relative wow fadeInUp" data-wow-delay=".9s" data-wow-duration="1s">
                                        <div className="row align-items-center">
                                            <div className="col-xl-3 col-lg-3 col-md-3">
                                                <div className="award__topic">
                                                    <p>CSS Design 2018</p>
                                            ...
                                            <div className="col-xl-7 col-lg-7 col-md-7">
                                                <div className="award__content-9">
                                                    <h3 className="award__title-9">
                                                        <a href="services-details.html" className="tp-img-reveal tp-img-reveal-item" data-img="assets/img/award/9/award-4.jpg" data-fx="1">Awwwards site of the day</a>
                                                    </h3>
                                                    <p>Runner Up - “ Decor of the week “</p>
                                                </div>
                                            </div>
                ...
                <section className="faq__area p-relative">
                    <div className="faq__video" data-background="assets/img/faq/faq-img.jpg">
                        <div className="faq__video-btn">
                            <a href="https://www.youtube.com/watch?v=FWrz3bT-YoE" className="tp-pulse-border popup-video">
                            ...
                            <div className="col-xxl-7 col-xl-7 col-lg-7">
                                <div className="faq__wrapper-2 faq__gradient-border faq__style-2 tp-accordion pl-160">
                                    <div className="faq__title-wrapper">
                                        <span className="faq__title-pre">Get in touch with us to see how</span>
                                        <h3 className="faq__title">Provide smart and flexible digital services</h3>
                                    </div>
                ...
                <section className="team__area pt-110 pb-110">
                    <div className="container">
                        <div className="row align-items-end">
                            <div className="col-xxl-5 col-xl-5 col-lg-6 col-md-6 col-sm-7">
                                <div className="section__title-wrapper mb-60">
                                    <h3 className="section__title">
                                        One
                                        <span className="section__title-highlight">Team<svg width="220" height="27" viewBox="0 0 220 27" fill="none">
                            ...
                            <div className="col-xxl-7 col-xl-7 col-lg-6 col-md-6 col-sm-5">
                                <div className="team__join mb-70 text-sm-end">
                                    <a href="team.html" className="tp-link-btn-2">
                                        Join Our Team
                                        <span>
                                ...
                                <div className="team__item">
                                    <div className="team__thumb w-img fix transition-3">
                                        ...
                                        <div className="team__action">
                                            <ul>
                                                <li>
                                                    <a href="mailto:team@harry.com"><i className="far fa-envelope"></i></a>
                                                </li>
                                                <li>
                                                    <a href="#"><i className="far fa-share-alt"></i></a>
                                    ...
                                    <div className="team__content">
                                        ...
                                        <span className="team__designation">Founder-CO</span>
                                    </div>
                                </div>
                            </div>
                            <div className="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                                <div className="team__item">
                                    ...
                                    <div className="team__content">
                                        ...
                                        <span className="team__designation">Product Designer</span>
                                    </div>
                                </div>
                            </div>
                            <div className="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                                <div className="team__item">
                                    ...
                                    <div className="team__content">
                                        ...
                                        <span className="team__designation">Creative Director</span>
                                    </div>
                                </div>
                            </div>
                            <div className="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                                <div className="team__item">
                                    ...
                                    <div className="team__content">
                                        ...
                                        <span className="team__designation">Developer</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <section className="cta__area cta__style-2 p-relative z-index-1">
                    <div className="cta__half-bg"></div>
                    <div className="container">
                        <div className="cta__inner-5" data-bg-color="blue-dark">
                            <div className="cta__shape-bg include-bg" data-background="assets/img/cta/5/cta-bg.png"></div>
                            <div className="row align-items-center">
                                <div className="col-xxl-8 col-xl-8 col-lg-8">
                                    <div className="cta__content-5">
                                        <span>Get to meet Your Next Agency</span>

                                        <h3 className="cta__title-5">Let’s talk about your next business challenge</h3>
                                    </div>
                                </div>
                                <div className="col-xxl-4 col-xl-4 col-lg-4">
                                    <div className="cta__btn-5 text-lg-end">
                                        <a href="contact.html" className="tp-btn-orange-2">Get in Touch</a>
                                    </div>
                                </div>
                            </div>
                        </div>
